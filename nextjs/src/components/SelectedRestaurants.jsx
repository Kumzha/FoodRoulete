  ...
  return (
    ...
    >
      <div className="relative h-full flex flex-col">
        ...
        <button 
          onClick={handleClick} 
          className="absolute top-6 left-1/2 font-bold transform -translate-x-1/2 -translate-y-1/2 bg-red-500 text-white text-xs px-8 py-2 rounded"
        >
          {expanded ? 'MINIMIZE CHOICES' : 'YOUR CHOICES'}
        </button>
